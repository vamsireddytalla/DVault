            ...
            when (action) {
                ACTION_START_FOREGROUND_SERVICE -> {
                    ...
                    if (intent.extras != null) {
                        sourceModelList =
                            intent.getSerializableExtra(this.resources.getString(R.string.fileCopy)) as List<SourcesModel>
                ...
                ACTION_STOP_FOREGROUND_SERVICE -> {
                    ...
                    fileCopyCallBack?.fileCopyCallBack(0, "Cancelled", "0/0", false)
...
//        builder.setContentIntent(pendingMainIntent)
    ...
    private fun updateNotification(progress: Int, mbCopied: String, totalCount: String) {
        ...
        fileCopyCallBack?.fileCopyCallBack(progress, mbCopied, totalCount, true)
...
//                }
    ...
    interface FileCopyCallback {
        fun fileCopyCallBack(progress: Int, mbCount: String, totalItems: String, isBinded: Boolean)
